...
invalid_e = '[WARNING] Некорректное значение e! Этот параметр будет сгенерирован автоматически.'

invalid_init_x = '[WARNING] Некорректное начальное значение x! Этот параметр будет сгенерирован автоматически.'
